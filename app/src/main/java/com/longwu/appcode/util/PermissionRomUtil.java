...
public class PermissionRomUtil {
    ...
    public String getPackageName() {
        Context mContext = APP.Companion.getMContext();
        if (mContext == null){
            return "";
        }
    ...
    public PermissionRomUtil(Context context) {
...
////            ComponentName comp = new ComponentName("com.android.settings", "com.android.settings.Settings$AccessLockSummaryActivity");
//            ComponentName comp = new ComponentName("com.google.android.permissioncontroller", "com.android.packageinstaller.permission.ui.ManagePermissionsActivity");
//            intent.setComponent(comp);
